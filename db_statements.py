...
COUNT_REWARDS_BY_COMPANY_NAME = "SELECT COUNT(*) FROM rewards WHERE LOWER(company_name) LIKE '{}%'"
COUNT_REWARDS_BY_COMPANY_NAME_FILTERED = "SELECT COUNT(*) FROM rewards WHERE LOWER(company_name) LIKE '{}%' AND reward_origin IN ({})"
